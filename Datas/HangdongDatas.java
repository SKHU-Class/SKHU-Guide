...
public class HangdongDatas extends Datas{
    public Pin[] pins = new Pin[]{
        new Pin(0, new Location(100, 100), "우가본", "images/TeamProject/MainMap.png", "<html>맛있는 우가본 어쩌구 입니다.</html>"),
        new Pin(1, new Location(200, 200), "우가본2", "images/TeamProject/MainMap.png", "<html>맛있는 우가본2 어쩌구 입니다.</html>"),
        new Pin(2, new Location(300, 300), "우가본3", "images/TeamProject/MainMap.png", "<html>맛있는 우가본3 어쩌구 입니다.</html>"),
    };
